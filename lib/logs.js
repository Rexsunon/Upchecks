/**
 * Library for storing and rotaing logs
 */
...
// Container for yhe module
let lib = {};

// Base directory of the logs folder
lib.baseDir = path.join(__dirname, '/../.logs/');

// Append a string to a file if it does not exist.
...
// Decompress the contents og .gz.b64 into a string variable
