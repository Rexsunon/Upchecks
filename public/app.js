/**
 * This is the fronend logic for the application
 */
...
// AJAX Client (for the restfil API)
app.client = {};
...
app.client.request = (headers,path,method,queryStringObject,payload,callback) => {
  ...
  // Set defaults
  headres = typeof(headers) == 'object' && headers !== null ? headers: {};
